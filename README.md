...
- [`docs/OPERRE_CRASH_RECOVERY_AND_UNSAVED_WORK_BEHAVIOR.md`](./docs/OPERRE_CRASH_RECOVERY_AND_UNSAVED_WORK_BEHAVIOR.md)
- [`docs/OPERRE_AUTO_SAVE_FILE_SAVING_ATOMIC_WRITE_AND_BACKUP_BEHAVIOR.md`](./docs/OPERRE_AUTO_SAVE_FILE_SAVING_ATOMIC_WRITE_AND_BACKUP_BEHAVIOR.md)
- [`docs/OPERRE_SYMLINK_HARDLINK_SPECIAL_FILE_AND_FILE_WATCHER_BEHAVIOR.md`](./docs/OPERRE_SYMLINK_HARDLINK_SPECIAL_FILE_AND_FILE_WATCHER_BEHAVIOR.md)
- [`docs/OPERRE_FILE_EXPLORER_WORKSPACE_TREE_FILE_INFO_TABS_AND_NAVIGATION_BEHAVIOR.md`](./docs/OPERRE_FILE_EXPLORER_WORKSPACE_TREE_FILE_INFO_TABS_AND_NAVIGATION_BEHAVIOR.md)
...
OPR-SPEC-0038 records the extension contribution and manifest model. Operre uses a TypeScript/JavaScript extension control plane, declarative manifests, default-deny permissions, sandboxed extension hosts, local installation, private registry planning, future single-VPS registry support, profile-aware sync planning, and brokered desktop/workstation external toolchain integration for C, C++, Python, database, web, linker, simulator, emulator, and live runtime tools.
